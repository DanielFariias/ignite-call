/*
  ...
  - You are about to alter the column `week_day` on the `user_time_intervals` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
